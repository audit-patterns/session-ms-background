...
for function in ${functions[@]}; do
  ...
  cp ./.npmrc ./src/functions/$function/.npmrc
  cp ./package.json ./src/functions/$function/package.json
  cp -r ./src/models ./src/functions/$function/models
  cp -r ./src/services ./src/functions/$function/services
  cp -r ./src/utils ./src/functions/$function/utils
  ...
  rm -rf ./src/functions/$function/.npmrc
  rm -rf ./src/functions/$function/package.json
  rm -rf ./src/functions/$function/models
  rm -rf ./src/functions/$function/services
  rm -rf ./src/functions/$function/utils
done
exit 0
